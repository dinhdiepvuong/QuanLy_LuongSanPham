 ...
 */
public class FrameCongNhan extends javax.swing.JInternalFrame implements ActionListener,ChangeListener{
	ThongKeBD_DAO tk_dao =new ThongKeBD_DAO();
	private DefaultCategoryDataset dataset;
	private ChartPanel chartPanel;
	private JLabel lblTongLuong;
	private JLabel jLabel5;
	private JLabel lblThuNhapKhac;
    /**
     * Creates new form FrameCongNhan
     */
    public FrameCongNhan() {
        initComponents();
        this.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,0,0,0));
        BasicInternalFrameUI ui = (BasicInternalFrameUI) this.getUI();
        ui.setNorthPane(null);
        
        List<ThongKe> ds = tk_dao.getBL(2021);
        List<ThongKe> dslct = tk_dao.getTNK(2021);
...
//      	pnDaTinhCN.repaint();
    ...
    private void initComponents() {
        ...
        cboQuy.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Qúy 1 ", "Quý 2", "Quý 3","Quý 4" }));
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(pnDaTinhCN, javax.swing.GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE))
        );
    ...
    public void VeBieudotheonam(int nam)
    {
    	List<ThongKe> ds = tk_dao.getBL(2021);
//      System.out.println(tach(ds.get(0).getTongluong()));
      double tongluong =0;
...
//      	pnDaTinhCN.repaint();
      ...
      {
    	  JOptionPane.showMessageDialog(null, "dsrongs");
      }
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
//			pnDaTinhCN.removeAll();
//			pnDaTinhCN.add(new JLabel("tét"));
//			System.out.println("nam" +Integer.parseInt(cboNam.getSelectedItem().toString()) );
//			VeBieudotheonam(Integer.parseInt(cboNam.getSelectedItem().toString()));
			List<ThongKe> ds = tk_dao.getBL(Integer.parseInt(cboNam.getSelectedItem().toString()));
			List<ThongKe> dslct = tk_dao.getTNK(Integer.parseInt(cboNam.getSelectedItem().toString()));
			double tongluong =0;
			double tnk = 0 ;
		      if(ds.size()>0)
		      {	
...
//		      	pnDaTinhCN.repaint();
		...
		{
			int quy = cboQuy.getSelectedIndex();
			List<ThongKe> ds = tk_dao.getLuongTheoQuy(Integer.parseInt(cboNam.getSelectedItem().toString()), quy);
			List<ThongKe> dslct = tk_dao.getTNKTheoQuy(Integer.parseInt(cboNam.getSelectedItem().toString()), quy);
			double tongluong =0;
			double tnk = 0 ;
		      if(ds.size()>0)
		      {	
