...
//				
//			}
//			else if(!ktrasdt(txtSDT.getText()))
//			{
//				
//			}
//			else if(!ktracmnd(txtCMND.getText()))
//			{
//				
//			}
...
//			
			...
			else if(txtTen.getText().equals("") | txtSDT.getText().equals("") |  txtCMND.getText().equals("") )
				 JOptionPane.showMessageDialog(this, "Vui lòng nhập dữ liệu");
			...
			if (result == JOptionPane.YES_OPTION){
			NhanVien_DAO nvdao = new NhanVien_DAO();
			NhanVien nv = new NhanVien(txtMa.getText(), txtTen.getText(),new java.sql.Date(dateNS.getDate().getTime()),new java.sql.Date( dateNVL.getDate().getTime()),Integer.parseInt(txtCMND.getText()) ,Integer.parseInt(txtSDT.getText()),cbGioitinh.getSelectedIndex() == 0 );
			nv.setPhongban(pb);
			if(nvdao.SuaNV(nv)) {
...
//		    jTable1.setModel(newModel);
	...
	for(int i=0;i<dsnv.size();i++)
	{
		int kt=dsnv.get(i).getCMND();
		if(cmnd==kt)
		{
			JOptionPane.showMessageDialog(null,"Trùng số chúng minh nhân dân");
		return false;
		}
	}
	return true;
